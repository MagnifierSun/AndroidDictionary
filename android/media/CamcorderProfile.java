...
/*     */   
/*     */   CamcorderProfile(int duration, int quality, int fileFormat, int videoCodec, int videoBitRate, int videoFrameRate, int videoWidth, int videoHeight, int audioCodec, int audioBitRate, int audioSampleRate, int audioChannels) {
...
/* Location:              M:\learn_android\android.jar!\android\media\CamcorderProfile.class
