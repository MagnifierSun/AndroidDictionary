...
/*    */   
/*    */   public static native void glDebugMessageControlKHR(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint, int paramInt5, boolean paramBoolean);
/*    */   
/*    */   public static native void glDebugMessageControlKHR(int paramInt1, int paramInt2, int paramInt3, int paramInt4, IntBuffer paramIntBuffer, boolean paramBoolean);
/*    */   
/*    */   public static native void glDebugMessageInsertKHR(int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString);
/*    */   
/*    */   public static native void glDebugMessageCallbackKHR(DebugProcKHR paramDebugProcKHR);
/*    */   
/*    */   public static native int glGetDebugMessageLogKHR(int paramInt1, int paramInt2, int[] paramArrayOfint1, int paramInt3, int[] paramArrayOfint2, int paramInt4, int[] paramArrayOfint3, int paramInt5, int[] paramArrayOfint4, int paramInt6, int[] paramArrayOfint5, int paramInt7, byte[] paramArrayOfbyte, int paramInt8);
/*    */   
/*    */   public static native int glGetDebugMessageLogKHR(int paramInt, IntBuffer paramIntBuffer1, IntBuffer paramIntBuffer2, IntBuffer paramIntBuffer3, IntBuffer paramIntBuffer4, IntBuffer paramIntBuffer5, ByteBuffer paramByteBuffer);
/*    */   
/*    */   public static native String[] glGetDebugMessageLogKHR(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3, int[] paramArrayOfint3, int paramInt4, int[] paramArrayOfint4, int paramInt5);
/*    */   
/*    */   public static native String[] glGetDebugMessageLogKHR(int paramInt, IntBuffer paramIntBuffer1, IntBuffer paramIntBuffer2, IntBuffer paramIntBuffer3, IntBuffer paramIntBuffer4);
/*    */   
/*    */   public static native void glPushDebugGroupKHR(int paramInt1, int paramInt2, int paramInt3, String paramString);
/*    */   
/*    */   public static native void glPopDebugGroupKHR();
/*    */   
/*    */   public static native void glObjectLabelKHR(int paramInt1, int paramInt2, int paramInt3, String paramString);
/*    */   
/*    */   public static native String glGetObjectLabelKHR(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glObjectPtrLabelKHR(long paramLong, String paramString);
/*    */   
/*    */   public static native String glGetObjectPtrLabelKHR(long paramLong);
/*    */   
/*    */   public static native DebugProcKHR glGetDebugMessageCallbackKHR();
/*    */   
/*    */   public static native void glMinSampleShadingOES(float paramFloat);
/*    */   
/*    */   public static native void glTexStorage3DMultisampleOES(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean);
/*    */   
/*    */   public static native void glCopyImageSubDataEXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12, int paramInt13, int paramInt14, int paramInt15);
/*    */   
/*    */   public static native void glEnableiEXT(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glDisableiEXT(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glBlendEquationiEXT(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glBlendEquationSeparateiEXT(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glBlendFunciEXT(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glBlendFuncSeparateiEXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
/*    */   
/*    */   public static native void glColorMaskiEXT(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4);
/*    */   
/*    */   public static native boolean glIsEnablediEXT(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glFramebufferTextureEXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4);
/*    */   
/*    */   public static native void glPrimitiveBoundingBoxEXT(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8);
/*    */   
/*    */   public static native void glPatchParameteriEXT(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glTexParameterIivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glTexParameterIivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glTexParameterIuivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glTexParameterIuivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetTexParameterIivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetTexParameterIivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetTexParameterIuivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetTexParameterIuivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glSamplerParameterIivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glSamplerParameterIivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glSamplerParameterIuivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glSamplerParameterIuivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetSamplerParameterIivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetSamplerParameterIivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetSamplerParameterIuivEXT(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetSamplerParameterIuivEXT(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glTexBufferEXT(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glTexBufferRangeEXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
/*    */   
...
/* Location:              M:\learn_android\android.jar!\android\opengl\GLES31Ext.class
