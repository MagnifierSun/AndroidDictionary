...
/*    */   
/*    */   public static native void glCopyImageSubData(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12, int paramInt13, int paramInt14, int paramInt15);
/*    */   
/*    */   public static native void glDebugMessageControl(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint, int paramInt5, boolean paramBoolean);
/*    */   
/*    */   public static native void glDebugMessageControl(int paramInt1, int paramInt2, int paramInt3, int paramInt4, IntBuffer paramIntBuffer, boolean paramBoolean);
/*    */   
/*    */   public static native void glDebugMessageInsert(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString);
/*    */   
/*    */   public static native void glDebugMessageCallback(DebugProc paramDebugProc);
/*    */   
/*    */   public static native int glGetDebugMessageLog(int paramInt1, int paramInt2, int[] paramArrayOfint1, int paramInt3, int[] paramArrayOfint2, int paramInt4, int[] paramArrayOfint3, int paramInt5, int[] paramArrayOfint4, int paramInt6, int[] paramArrayOfint5, int paramInt7, byte[] paramArrayOfbyte, int paramInt8);
/*    */   
/*    */   public static native int glGetDebugMessageLog(int paramInt, IntBuffer paramIntBuffer1, IntBuffer paramIntBuffer2, IntBuffer paramIntBuffer3, IntBuffer paramIntBuffer4, IntBuffer paramIntBuffer5, ByteBuffer paramByteBuffer);
/*    */   
/*    */   public static native String[] glGetDebugMessageLog(int paramInt1, int[] paramArrayOfint1, int paramInt2, int[] paramArrayOfint2, int paramInt3, int[] paramArrayOfint3, int paramInt4, int[] paramArrayOfint4, int paramInt5);
/*    */   
/*    */   public static native String[] glGetDebugMessageLog(int paramInt, IntBuffer paramIntBuffer1, IntBuffer paramIntBuffer2, IntBuffer paramIntBuffer3, IntBuffer paramIntBuffer4);
/*    */   
/*    */   public static native void glPushDebugGroup(int paramInt1, int paramInt2, int paramInt3, String paramString);
/*    */   
/*    */   public static native void glPopDebugGroup();
/*    */   
/*    */   public static native void glObjectLabel(int paramInt1, int paramInt2, int paramInt3, String paramString);
/*    */   
/*    */   public static native String glGetObjectLabel(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glObjectPtrLabel(long paramLong, String paramString);
/*    */   
/*    */   public static native String glGetObjectPtrLabel(long paramLong);
/*    */   
/*    */   public static native long glGetPointerv(int paramInt);
/*    */   
/*    */   public static native void glEnablei(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glDisablei(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glBlendEquationi(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glBlendEquationSeparatei(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glBlendFunci(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glBlendFuncSeparatei(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
/*    */   
/*    */   public static native void glColorMaski(int paramInt, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4);
/*    */   
/*    */   public static native boolean glIsEnabledi(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glDrawElementsBaseVertex(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer, int paramInt4);
/*    */   
/*    */   public static native void glDrawRangeElementsBaseVertex(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, Buffer paramBuffer, int paramInt6);
/*    */   
/*    */   public static native void glDrawElementsInstancedBaseVertex(int paramInt1, int paramInt2, int paramInt3, Buffer paramBuffer, int paramInt4, int paramInt5);
/*    */   
/*    */   public static native void glDrawElementsInstancedBaseVertex(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6);
/*    */   
/*    */   public static native void glFramebufferTexture(int paramInt1, int paramInt2, int paramInt3, int paramInt4);
/*    */   
/*    */   public static native void glPrimitiveBoundingBox(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, float paramFloat8);
/*    */   
/*    */   public static native int glGetGraphicsResetStatus();
/*    */   
/*    */   public static native void glReadnPixels(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, Buffer paramBuffer);
/*    */   
/*    */   public static native void glGetnUniformfv(int paramInt1, int paramInt2, int paramInt3, float[] paramArrayOffloat, int paramInt4);
/*    */   
/*    */   public static native void glGetnUniformfv(int paramInt1, int paramInt2, int paramInt3, FloatBuffer paramFloatBuffer);
/*    */   
/*    */   public static native void glGetnUniformiv(int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfint, int paramInt4);
/*    */   
/*    */   public static native void glGetnUniformiv(int paramInt1, int paramInt2, int paramInt3, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetnUniformuiv(int paramInt1, int paramInt2, int paramInt3, int[] paramArrayOfint, int paramInt4);
/*    */   
/*    */   public static native void glGetnUniformuiv(int paramInt1, int paramInt2, int paramInt3, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glMinSampleShading(float paramFloat);
/*    */   
/*    */   public static native void glPatchParameteri(int paramInt1, int paramInt2);
/*    */   
/*    */   public static native void glTexParameterIiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glTexParameterIiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glTexParameterIuiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glTexParameterIuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetTexParameterIiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetTexParameterIiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetTexParameterIuiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetTexParameterIuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glSamplerParameterIiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glSamplerParameterIiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glSamplerParameterIuiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glSamplerParameterIuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetSamplerParameterIiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetSamplerParameterIiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glGetSamplerParameterIuiv(int paramInt1, int paramInt2, int[] paramArrayOfint, int paramInt3);
/*    */   
/*    */   public static native void glGetSamplerParameterIuiv(int paramInt1, int paramInt2, IntBuffer paramIntBuffer);
/*    */   
/*    */   public static native void glTexBuffer(int paramInt1, int paramInt2, int paramInt3);
/*    */   
/*    */   public static native void glTexBufferRange(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
/*    */   
/*    */   public static native void glTexStorage3DMultisample(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, boolean paramBoolean);
/*    */   
...
/* Location:              M:\learn_android\android.jar!\android\opengl\GLES32.class
