...
public interface Spanned extends CharSequence {
  ...
  <T> T[] getSpans(int paramInt1, int paramInt2, Class<T> paramClass);
  
  int getSpanStart(Object paramObject);
  
  int getSpanEnd(Object paramObject);
  
  int getSpanFlags(Object paramObject);
  
  int nextSpanTransition(int paramInt1, int paramInt2, Class paramClass);
}


/* Location:              M:\learn_android\android.jar!\android\text\Spanned.class
